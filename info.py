...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5056925533').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002104043505 -1002270174203 -1001897244651').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001908798887') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002079936620')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002141041003')).split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pebef88860:pebef88860@cluster0.uens2hb.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://Autodb02:Autodb02@autodb02.xpctg.mongodb.net/?retryWrites=true&w=majority&appName=Autodb02")   # This Db Is For File Data Store
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://web-m3j6osw1fih1.up-de-fra1-k8s-1.apps.run-on-seenode.com/")
